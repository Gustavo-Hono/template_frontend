    ...
    return (
        <SidebarProvider>
            ...
            <main className="flex-1">
                <div className="flex w-full p-4 border-b border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-950/50 backdrop-blur-sm sticky top-0 z-10">
                    <SidebarTrigger />
                </div>
                <div className="flex min-h-[calc(100vh-65px)] flex-col items-center justify-center space-y-8 bg-zinc-50 p-8 font-sans dark:bg-black">
                    ...
                    <div className="flex flex-col items-center space-y-4 bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 w-full max-w-md">
                        <div className="space-y-2 text-center w-full">
                            <h3 className="font-medium text-zinc-900 dark:text-zinc-100">User Profile</h3>
